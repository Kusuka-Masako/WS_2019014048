...
import ws.exercise1.ws.exercise1.exceptions.NonexistentEntityException;
import ws.exercise1.ws.exercise1.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.exercise1_ws.exercise1_jar_0.0.1-SNAPSHOTPU");
