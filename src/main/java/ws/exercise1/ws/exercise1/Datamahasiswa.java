...
@NamedQueries({
    ...
    @NamedQuery(name = "Datamahasiswa.findByFakulktas", query = "SELECT d FROM Datamahasiswa d WHERE d.fakulktas = :fakulktas")})
public class Datamahasiswa implements Serializable {
    ...
    @Column(name = "fakulktas")
    private String fakulktas;
    ...
    public String getFakulktas() {
        return fakulktas;
    }

    public void setFakulktas(String fakulktas) {
        this.fakulktas = fakulktas;
    }
    ...
    public String toString() {
        return "ws.exercise1.ws.exercise1.Datamahasiswa[ nim=" + nim + " ]";
    }
